 ...
 *
 * @method     sfGuardGroupQuery leftJoinProjectUser($relationAlias = null) Adds a LEFT JOIN clause to the query using the ProjectUser relation
 * @method     sfGuardGroupQuery rightJoinProjectUser($relationAlias = null) Adds a RIGHT JOIN clause to the query using the ProjectUser relation
 * @method     sfGuardGroupQuery innerJoinProjectUser($relationAlias = null) Adds a INNER JOIN clause to the query using the ProjectUser relation
 *
...
abstract class BasesfGuardGroupQuery extends ModelCriteria
{
	...
	{
		return $this
			->addUsingAlias(sfGuardGroupPeer::ID, $projectUser->getSfGuardGroupId(), $comparison);
	}
